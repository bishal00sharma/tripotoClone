...
import {
    ...
    FormHelperText,Input,Spacer,Select,Stack,Checkbox, GridItem
  } from '@chakra-ui/react'
import FaqSection from "./FaqSection";
import Middle6Part from "../Middle/Middle6Part";
import {useNavigate} from "react-router-dom";
import Nav from "../Navbar/Nav";

export default function TripPage(){
  
  const {formValue1,fillForm1,formValue2,fillForm2} =useContext(AppContext);
...
function getData(){
                 axios.get(`https://apitripoto.herokuapp.com/travel/${id}`).then((res)=>{setData(res.data);fillForm2(res.data)})
      ...
      <p>All bookings for Tripoto Mindful Retreats are non-refundable.</p>
        ...
        <FormControl>
         ...
         I accept the Terms of Use and Policy.
            ...
            <Button onClick={handleSubmit} borderColor='green.500' colorScheme='blue' style={{width:"90%",marginTop:"30px"}}>Next</Button>
        </div>
